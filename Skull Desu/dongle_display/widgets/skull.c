...
LV_IMG_DECLARE(SKULL_IDLE1);
LV_IMG_DECLARE(SKULL_IDLE2);
LV_IMG_DECLARE(SKULL_SLOW);
LV_IMG_DECLARE(SKULL_MED1);
LV_IMG_DECLARE(SKULL_MED2);
LV_IMG_DECLARE(SKULL_MED3);
LV_IMG_DECLARE(SKULL_FAST1);
LV_IMG_DECLARE(SKULL_FAST2);
LV_IMG_DECLARE(SKULL_FAST3);
...
#define ANIMATION_SPEED_SLOW 500
